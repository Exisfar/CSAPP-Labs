...
0000000000400f43 <phase_3>:
  400f43:	48 83 ec 18          	sub    $0x18,%rsp # *rsp = *rsp - 0x18
  ...
  400f63:	7f 05                	jg     400f6a <phase_3+0x27> # jump if read more than one argument
  400f65:	e8 d0 04 00 00       	call   40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp) # compare *(rsp+0x8) with 7
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a> # explode bomb if *(rsp+0x8) > 7
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax # else, *eax = *(rsp+0x8)
  400f75:	ff 24 c5 70 24 40 00 	jmp    *0x402470(,%rax,8) # '*'表示间接跳转，0x402470是跳转表的基地址，​​(,%rax,8)​​是变址寻址，计算方式为 基址 + %rax * 8
...
0000000000400fce <func4>:
  400fce:	48 83 ec 08          	sub    $0x8,%rsp # *rsp = *rsp - 0x8
  ...
  400fdd:	d1 f8                	sar    %eax # *eax = *eax >> 1 (7)
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx # *ecx = *rax + *rsi (7 + 0)
  400fe2:	39 f9                	cmp    %edi,%ecx # compare *ecx (7) with *edi (the first input number)
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> # jump if *ecx <= *edi
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx # *edx = *rcx - 1 (6)
  400fe9:	e8 e0 ff ff ff       	call   400fce <func4> # recursive call
  400fee:	01 c0                	add    %eax,%eax # *eax = *eax + *eax (2 * *eax)
  400ff0:	eb 15                	jmp    401007 <func4+0x39> # jump to the end
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax # *eax = 0
  400ff7:	39 f9                	cmp    %edi,%ecx # compare *ecx with *edi (0)
  400ff9:	7d 0c                	jge    401007 <func4+0x39> # jump if *ecx >= *edi
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi # *esi = *rcx + 1
  400ffe:	e8 cb ff ff ff       	call   400fce <func4> # recursive call
  401007:	48 83 c4 08          	add    $0x8,%rsp # *rsp = *rsp + 0x8
  40100b:	c3                   	ret

000000000040100c <phase_4>:
  40100c:	48 83 ec 18          	sub    $0x18,%rsp # *rsp=*rsp-0x18
  ...
  401029:	83 f8 02             	cmp    $0x2,%eax # compare eax with 2
  40102c:	75 07                	jne    401035 <phase_4+0x29> # explode if the number of inputs isn't 2
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp) # compare the first input number with 0xe (14)
  401033:	76 05                	jbe    40103a <phase_4+0x2e> # jump if the first input number is less than or equal to 14
  401035:	e8 00 04 00 00       	call   40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx # *edx = 0xe (14)
  40103f:	be 00 00 00 00       	mov    $0x0,%esi # *esi = 0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi # *edi = the first input number
  401048:	e8 81 ff ff ff       	call   400fce <func4>
  40104d:	85 c0                	test   %eax,%eax # test eax with eax
  40104f:	75 07                	jne    401058 <phase_4+0x4c> # explode if eax != 0
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp) # compare the second input number with 0
  401056:	74 05                	je     40105d <phase_4+0x51> # jump if the second input number is 0
  401058:	e8 dd 03 00 00       	call   40143a <explode_bomb> # else explode
  40105d:	48 83 c4 18          	add    $0x18,%rsp # *rsp = *rsp + 0x18
  401061:	c3                   	ret
